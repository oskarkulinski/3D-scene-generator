...
def build_discriminator():
    ...
    conv2d_3 = tf.keras.layers.Conv2D(64, kernel_size=3, strides=2, padding='same')(conv2d_2)
    conv2d_3 = tf.keras.layers.BatchNormalization(momentum=0.8)(conv2d_3)
    conv2d_3 = tf.keras.layers.LeakyReLU(alpha=0.2)(conv2d_3)

    conv2d_4 = tf.keras.layers.Conv2D(32, kernel_size=3, strides=2, padding='same')(conv2d_3)
