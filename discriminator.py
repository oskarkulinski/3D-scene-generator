...
def build_discriminator():
    ...
    conv2d_1 = tf.keras.layers.Conv2D(4, kernel_size=3, strides=2, padding='same')(image_input)
    ...
    pool_2 = tf.keras.layers.AveragePooling2D(pool_size=2, strides=2)(pool_1)
    ...
    label_embedding = tf.keras.layers.Dense(16 * 16 * 64, activation="relu")(label_embedding)
    label_embedding = tf.keras.layers.Reshape((16, 16, 64))(label_embedding)
