...
def build_generator():
    ...
    conv_1 = tf.keras.layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(upsample_1)
    ...
    conv_2 = tf.keras.layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(upsample_2)
    ...
    conv_3 = tf.keras.layers.Conv2D(128, kernel_size=3, padding='same', activation='relu')(upsample_3)
    ...
    conv_4 = tf.keras.layers.Conv2D(64, kernel_size=3, padding='same', activation='relu')(upsample_4)
